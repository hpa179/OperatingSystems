...
#define AVERAGEPROG 6034
#define AVERAGEVERS 1

#if defined(__STDC__) || defined(__cplusplus)
#define AVERAGE 1
extern  input_data * average_1(input_data *, CLIENT *);
extern  input_data * average_1_svc(input_data *, struct svc_req *);
extern int averageprog_1_freeresult (SVCXPRT *, xdrproc_t, caddr_t);

#else /* K&R C */
#define AVERAGE 1
extern  input_data * average_1();
extern  input_data * average_1_svc();
